...
LangString alreadyInstalledLong ${LANG_SIMPCHINESE} "${PRODUCTNAME} ${VERSION} 已安装。点击下一步将移除现有版本并安装当前安装包。"
...
LangString newerVersionInstalled ${LANG_SIMPCHINESE} "系统中已安装更高版本的 ${PRODUCTNAME}。点击下一步将其替换为较旧的 ${VERSION}。"
LangString older ${LANG_SIMPCHINESE} "旧的"
LangString olderOrUnknownVersionInstalled ${LANG_SIMPCHINESE} "系统中已安装 $R4 版本的 ${PRODUCTNAME}。点击下一步将其替换为 ${VERSION}。"
...
LangString uninstallApp ${LANG_SIMPCHINESE} "替换已安装版本"
