...
LangString alreadyInstalledLong ${LANG_ENGLISH} "${PRODUCTNAME} ${VERSION} is already installed. Click Next to remove the installed version and install this package."
...
LangString newerVersionInstalled ${LANG_ENGLISH} "A newer version of ${PRODUCTNAME} is installed. Click Next to replace it with the older ${VERSION} package."
LangString older ${LANG_ENGLISH} "older"
LangString olderOrUnknownVersionInstalled ${LANG_ENGLISH} "An $R4 version of ${PRODUCTNAME} is installed. Click Next to replace it with ${VERSION}."
...
LangString uninstallApp ${LANG_ENGLISH} "Replace installed version"
