// dsh-desktop-relay — frame protocol constants and validation.
//
// The relay moves bytes between a phone (browser) and a PC (relay client)
// without understanding dsh. Each side speaks the same JSON frame line
// protocol, one frame per WS text message. See README.md for the wire spec.
//
